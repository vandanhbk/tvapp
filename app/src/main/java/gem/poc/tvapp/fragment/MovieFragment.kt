...
import gem.poc.tvapp.DetailActivity
import gem.poc.tvapp.HomeFragment
import gem.poc.tvapp.ListFragment
import gem.poc.tvapp.MyApplication
import gem.poc.tvapp.R
import gem.poc.tvapp.SecondListFragment
...
class MovieFragment : Fragment() {
    ...
    lateinit var listFragment: SecondListFragment
    ...
    fun init(view: View) {
        ...
        listFragment = SecondListFragment()
        ...
        */
        ...
        listFragment.setOnContentSelectedListener {
            ...
            handler.postDelayed(playTrailerRunnable, 4000)
        }
